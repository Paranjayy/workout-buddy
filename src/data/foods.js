// Global food database — cuisines from around the world
// Calories are per typical serving
...
export const FOOD_DB = [
  ...
  { name: 'Enchiladas', cal: 350, protein: 16, carbs: 28, fat: 18, region: '🇲🇽 Mexican', serving: '1 piece' },
  ...
  { name: 'Som Tum (Papaya Salad)', cal: 120, protein: 3, carbs: 16, fat: 5, region: '🇹🇭 Thai', serving: '1 cup' },
  ...
  { name: 'Spanakopita', cal: 260, protein: 8, carbs: 20, fat: 16, region: '🇬🇷 Mediterranean', serving: '1 piece' },
  ...
  // Ethiopian
  { name: 'Injera with Doro Wat', cal: 480, protein: 26, carbs: 50, fat: 18, region: '🇪🇹 Ethiopian', serving: '1 plate' },
  ...
  // Common basics
  { name: 'Rice (White, Cooked)', cal: 200, protein: 4, carbs: 44, fat: 0.4, region: '🌍 Basic', serving: '1 cup' },
  ...
  { name: 'Almonds', cal: 165, protein: 6, carbs: 6, fat: 14, region: '🌍 Basic', serving: '1 oz (23 nuts)' },
  ...
  { name: 'Milk (Whole)', cal: 150, protein: 8, carbs: 12, fat: 8, region: '🌍 Basic', serving: '1 cup' },
...
export function getRegions() {
  return [...new Set(FOOD_DB.map(f => f.region))];
}
